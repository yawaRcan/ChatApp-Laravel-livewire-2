<div>
    <style>
     ...
     @if(count($users)>0)
    <div class="intro-y text-lg font-medium">Send Friend Request</div>
    ...
    <div class="modal-content__scrollable overflow-y-auto scrollbar-hidden -mx-4 px-4 mt-4">
        <div class="user-list" style="height: 500px; overflow-y: scroll; overflow-x: hidden">
            ...
            <div class="intro-y pb-3">
                <div class="intro-y block">
                    <div class="box dark:bg-dark-3 cursor-pointer relative flex items-center px-4 py-3 zoom-in">
                       ...
                       <a href="javascript:;" onclick="confirm('Are you sure you want to remove the request?') || event.stopImmediatePropagation()" wire:click="deleteRequest({{$data->id}})" class="btn btn-sm btn-info ml-auto"> Delete </a>
